                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown messages-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span id="msg-counter" class="label label-success"></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li id="msg-header" class="header text-center">Sem mensagens no momento</li>
                                <li id="msg-list">
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                ...
                                <li class="footer"><a id="msg-link-to-all" href="#">Veja todas as mensagens</a></li>
                            </ul>
                        </li>
